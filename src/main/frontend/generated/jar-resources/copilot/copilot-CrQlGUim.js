...
const qn = async (e, t, n) => window.Vaadin.copilot.comm(e, t, n), Ce = "copilot-", Ks = "24.6.2", Uc = "attention-required", Bc = "https://plugins.jetbrains.com/plugin/23758-vaadin", zc = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode";
function Fc(e) {
...
function Cl() {
  we.push(import("./copilot-log-plugin-DYQvCFtu.js")), we.push(import("./copilot-info-plugin-lu469wng.js")), we.push(import("./copilot-features-plugin-CwTNLFWc.js")), we.push(import("./copilot-feedback-plugin-DowkizOf.js")), we.push(import("./copilot-shortcuts-plugin-COXZs7tl.js"));
}
function Dl() {
  {
...
let Jr = class extends Pl {
  ...
  async init() {
    if (this.initialized)
      return;
    await window.Vaadin.copilot._machineState.initializer.promise, document.body.style.setProperty("--dev-tools-button-display", "none"), await import("./copilot-global-vars-later-BN3v0Whn.js"), await import("./copilot-init-step2-B1AnEveI.js"), Vl(), Cl(), this.tabIndex = 0, Dt.hostConnectedCallback(), window.addEventListener("keydown", Br), A.onSend(this.handleSendEvent), this.removers.push(A.on("close-drawers", this.closeDrawers.bind(this))), this.removers.push(
